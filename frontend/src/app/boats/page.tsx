            ...
            <header className="relative py-20 lg:py-24 px-4 bg-black overflow-hidden flex flex-col justify-center min-h-[40vh] lg:min-h-[450px] border-b border-border/10 text-center -mx-4 sm:-mx-6 lg:-mx-8 mb-16">
                ...
                <div className="max-w-7xl mx-auto relative z-10 w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 w-full">
                        <span className="text-sm font-bold tracking-widest text-primary uppercase mb-4 inline-block drop-shadow-md bg-black/30 px-4 py-1.5 rounded-full border border-primary/20 backdrop-blur-sm">Sejlere i verden</span>
                        ...
                        <div className="mt-8 text-sm font-bold uppercase tracking-widest bg-primary/90 text-white px-6 py-3 rounded-full backdrop-blur shadow-xl border border-white/10 inline-block">
                    ...
                    <div className="w-full max-w-md lg:w-[450px] shrink-0 bg-black/40 backdrop-blur-md border border-white/20 rounded-3xl p-6 md:p-8 flex flex-col gap-5 text-left shadow-2xl transform lg:-rotate-2 lg:hover:rotate-0 transition-all duration-300">
                        <div className="flex items-center gap-4">
                            ...
                            <h3 className="text-xl md:text-2xl font-bold font-merriweather text-white drop-shadow-sm leading-tight">Hjælp os med at få flere både med! ⚓️</h3>
                        </div>
