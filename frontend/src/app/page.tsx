    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="mb-16 text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8">
          Følg de danske sejlere på langfart, dyk ned i logbøgerne fra verdenshavene, og bliv en del af Danmarks største fællesskab for langturssejlere.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="w-full sm:w-auto px-8 py-3 bg-[#1877F2] hover:bg-[#1877F2]/90 text-white font-bold rounded-full transition-all flex items-center justify-center gap-2"
          >
          ...
          <Link
            href="/register"
            className="w-full sm:w-auto px-8 py-3 bg-primary text-primary-foreground font-bold rounded-full hover:bg-primary/90 transition-all border border-transparent"
          >
            Vær med
          </Link>
        </div>
