...
export default function SearchBar() {
    ...
    return (
        <div ref={wrapperRef} className="relative w-full md:w-64 lg:w-80 group">
            ...
            {isOpen && (
                <div className="absolute top-full mt-2 left-0 right-0 w-full min-w-[300px] md:w-[400px] md:-right-12 md:left-auto bg-background border border-border rounded-xl shadow-2xl overflow-hidden z-[100]">
