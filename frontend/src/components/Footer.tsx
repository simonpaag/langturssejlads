                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
                    <div className="md:col-span-2 pr-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a href="https://www.youtube.com/@Langturssejlads" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background rounded-full text-muted-foreground hover:text-primary hover:scale-110 transition-all shadow-sm border border-border" aria-label="YouTube">
