            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
                    <div className="md:col-span-2 pr-4">
                        <Link href="/" className="flex items-center gap-3 group mb-6">
                            ...
                            <span className="font-merriweather font-black text-2xl tracking-tighter uppercase text-foreground">Llangturssejlads</span>
                        </Link>
                    ...
                    <div>
                        ...
                        <address className="not-italic text-sm font-medium text-muted-foreground space-y-3">
                            <p>Llangturssejlads.dk</p>
                            <p>Overgaden Oven Vandet 8</p>
                            <p>1415 København K.</p>
                            <p>Danmark</p>
                            <p className="pt-2">
                                <a href="mailto:kontakt@llangturssejlads.dk" className="hover:text-primary transition-colors border-b border-primary/30 pb-1">kontakt@llangturssejlads.dk</a>
                            </p>
                        </address>
                    </div>
                </div>
                ...
                <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    <p className="text-xs font-bold text-muted-foreground/70 tracking-widest uppercase text-center md:text-left">
                        &copy; {new Date().getFullYear()} Llangturssejlads. Alle rettigheder forbeholdes.
                    </p>
